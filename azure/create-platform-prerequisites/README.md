...
This documentation describes the Azure prerequisite infrastructure needed to install the Cosmo Tech Simulation Platform using Terraform. The Terraform script creates Azure resources, app registrations and specific Cosmo Tech Simulation Platform roles. Here is the detail of the resources created
